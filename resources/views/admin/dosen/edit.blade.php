...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Mengedit Data Dosen</h1>

    <!-- Form -->
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="{{url('admin/dosen/update', $dosen->id)}}" method="POST" class="space-y-4" enctype="multipart/form-data">
                @csrf
